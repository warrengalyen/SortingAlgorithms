...
public class Main extends JApplet {
    ...
    class SortPanelsHolder extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            FontMetrics animationNameFontMetric = getFontMetrics(animationNameFont);
            g.setFont(animationNameFont);
            int x = (getWidth() - animationNameFontMetric.stringWidth(animationName)) / 2;
            int y = (getHeight() - animationNameFontMetric.getLeading()) / 2;
